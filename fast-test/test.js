var AsService = require("../lib/AsService");
//1- primitive type (number | string | Array) as service
var srv1 = new AsService.default(5); // number as service
srv1.subscribe(function (a) { return console.log("ser1 data via observable is:", a); });
//srv1.load().then(function (a) { return console.log("ser1 data via promis:", a); },66);
...
var srv2 = new AsService.default({ x: 9 }); // object as service
srv2.Observable()
...
var srv3 = new AsService.default(function (param) { return param * 3; }); // function as service
...
var ser4 = new AsService.default(function (param) { return new Promise(function (res /*,rej*/) { return res("im promise with parameter: " + param); }); });
...
//6- observe state
var srv6 = new AsService.default(function (p) { return 2 * p; });
