...
srv5.Observable("param1 value", "param2 value").subscribe(function (a) {
  return console.log("srv5:", a);
}); //6- observe state

var srv6 = new _AsService.default(function (p) {
  return 2 * p;
});
srv6.StateObservable(77).subscribe(function (a) {
  return console.log("current state is: ", a);
});
srv6.load(77);