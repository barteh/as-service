      ...
      return new Promise(function (res, rej) {
        _localforage.default.getItem(hash).then(function (a) {
          ...
          (0, _axios.default)({
            ...
            if (d.header) {
              if (d.header.result !== 0) return rej(d.data);
            } else {
            ...
            return rej(d.request.status); //  Server.errorHandler(options, d.request.status);
          });
        });
      });
    }
      ...
      return new Promise(function (res, rej) {
        _localforage.default.getItem(hash).then(function (a) {
          ...
          (0, _axios.default)({
            ...
            if (d.header) {
              if (d.header.result !== 0) return rej(d.data);else return res(d.data);
            } else return res(d);
          }).catch(function (d) {
            Server.afterRecieve();
            Server.errorHooks(d.request.status);
