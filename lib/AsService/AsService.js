...
function () {
  ...
  function AsService(loader, mapper, autoload, paramcount, forceSourceLoad) {
    ...
    _defineProperty(this, "_stateSub", new _rxjs.default.BehaviorSubject());
  ...
  _createClass(AsService, [{
    ...
    key: "StateObservable",
    value: function StateObservable() {
      for (var _len2 = arguments.length, params = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        params[_key2] = arguments[_key2];
      }

      var subFor = this.getSub(params);
      return subFor.stateSub.filter(function (a) {
        return a !== undefined;
      });
    }
  }, {
    ...
    value: function getSub() {
      ...
      if (!this._subs[tmp]) {
        var _this$_source4, _this$_source5, _this$_source6;
        ...
        this._subs[tmp] = {
          ...
          errorSub: this._source === undefined ? new _rxjs.default.BehaviorSubject() : (_this$_source5 = this._source).ErrorObservable.apply(_this$_source5, params),
          stateSub: this._source === undefined ? new _rxjs.default.BehaviorSubject() : (_this$_source6 = this._source).StateObservable.apply(_this$_source6, params),
