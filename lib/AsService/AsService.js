  ...
  _createClass(AsService, [{
      ...
      if (!this._subs[tmp]) {
        ...
        this._subs[tmp] = {
          sub: this._source === undefined ? new _rxjs.default.BehaviorSubject() : (_this$_source3 = this._source).Observable.apply(_this$_source3, params).map(function (a) {
            return _this4._mapper.apply(_this4, [a].concat(_toConsumableArray(pars)));
          }),
    ...
    value: function _reload() {
      ...
      var ret = new Promise(function (res, rej) {
        ...
        var fnret = _this5._loader.apply(_this5, params);
        ...
        if (r._isScalar !== undefined) {
          ...
          subfor.sourceObservable = r.subscribe(function (b) {
            var ret = _this5._mapper ? _this5._mapper.apply(_this5, [b].concat(params)) : b;
            subfor.sub.next(ret);

            _this5._sub.next(ret);
          });
        } else if (r instanceof Promise) {
          fnret.then(function (d) {
            subfor.state = "idle";
            var ret = _this5._mapper ? _this5._mapper.apply(_this5, [d].concat(params)) : d;
            _this5.$data = ret;
            res(ret);
            subfor.sub.next(ret);
            ...
            _this5._errorSub.next(e);
          });
        } else {
          var _ret2 = _this5._mapper ? _this5._mapper.apply(_this5, [r].concat(params)) : r;

          res(_ret2);
          subfor.sub.next(_ret2);

          _this5._sub.next(_ret2);
